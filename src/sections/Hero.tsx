    ...
    return (
        <section className="py-24 md:py-52 overflow-x-clip">
            <div className="container">
                ...
                <h1 className="font-heading font-black text-5xl md:text-6xl lg:text-7xl text-center mt-4 max-w-2xl mx-auto">The Future of Blockchain is Here.</h1>
                ...
                <div className="flex justify-center mt-24">
                    <div className="inline-flex  relative z-0">
                        ...
                        <img src="/assets/images/icosahedron.png" alt="" className="absolute w-[calc(100%+100px)] max-w-none -z-10 left-1/2 -translate-y-1/2 top-1/2 -translate-x-1/2 saturate-[10%] brightness-[4%] hue-rotate-[240deg]" />
