...
const cardData = [{
  ...
  description: 'Effortlessly integrate and manage data with our cutting-edge API, designed for seamless connectivity.',
  color: 'fuchsia'
}, {
      ...
      <div className="container">
        ...
        <div className="mt-36 lg:mt-48 flex">
          <div className="flex flex-none gap-8">
            ...
            (
              <div key={index} className="relative z-0 p-8 md:p-10 max-w-xs md:max-w-md group">
                ...
                <div className="justify-center flex -mt-28">
                  <div className="inline-flex relative">
                    ...
                    <img src={image} alt={title} className="size-40 group-hover:-translate-y-6 transition duration-300" />
                  </div>
                </div>
                ...
                <div className="flex justify-between mt-12">
                  <button className={twMerge("text-sm font-heading text-fuchsia-500 uppercase font-extrabold tracking-wider",
        ...
        <div className="flex justify-center mt-10">
          <div className="bg-zinc-950 inline-flex gap-4 p-2.5 rounded-full">
            {cardData.map(({ title }) => (
              <div key={title} className="size-2.5 bg-zinc-500 rounded-full cursor-pointer">
